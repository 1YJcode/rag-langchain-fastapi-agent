...
from backend.app.core.failed_response_register import register_exception_handlers
from backend.app.core.logger_handler import logger
from backend.app.core.rate_limit import RateLimitMiddleware
from backend.app.db.db_config import init_db
from backend.app.db.redis_config import connect_redis, close_redis
